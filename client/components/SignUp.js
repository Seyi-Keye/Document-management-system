...
class SignUp extends React.Component {
  ...
  constructor(props) {
    ...
    // mapDispatchToProps = this.mapDispatchToProps.bind(this);
    // mapStateToProps = this.mapStateToProps.bind(this);
  };
  ...
  mapDispatchToProps(dispatch) {
    return {createUser: user => dispatch(userActions.createUser(user))}
  };
