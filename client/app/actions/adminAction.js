...
export const fetchUserSuccessful = users => ({
  type: ActionTypes.FETCH_USERS_SUCCESSFUL, response: users });
export const fetchUserError = error => ({
  type: ActionTypes.FETCH_USERS_FAIL, error });

export const UpdateUserRequest = () => ({
  type: ActionTypes.UPDATE_USER_REQUEST });
export const UpdateUserSuccessful = users => ({
  type: ActionTypes.UPDATE_USER_SUCCESSFUL, response: users });
export const UpdateUserError = error => ({
  type: ActionTypes.UPDATE_USER_FAIL, error });

export const deleteUserRequest = () => ({
  type: ActionTypes.DELETE_USER_REQUEST });
export const deleteUserSuccessful = id => ({
  type: ActionTypes.DELETE_USER_SUCCESSFUL, response: id });
export const deleteUserError = error => ({
  type: ActionTypes.DELETE_USER_FAIL, error });

export const createRoleRequest = () => ({
  type: ActionTypes.CREATE_ROLE_REQUEST });
export const createRoleSuccessful = title => ({
  type: ActionTypes.CREATE_ROLE_SUCCESSFUL, response: title });
export const createRoleError = error => ({
  type: ActionTypes.CREATE_ROLE_FAIL, error });

export const fetchRoleRequest = () => ({
  type: ActionTypes.FETCH_ROLE_REQUEST });
export const fetchRoleSuccessful = role => ({
  type: ActionTypes.FETCH_ROLE_SUCCESSFUL, response: role });
export const fetchRoleError = error => ({
  type: ActionTypes.FETCH_ROLE_FAIL, error });

export const searchUserRequest = () => ({
  type: ActionTypes.SEARCH_USER_REQUEST });
export const searchUserSuccessful = users => ({
  type: ActionTypes.SEARCH_USER_SUCCESSFUL, response: users });
export const searchUserError = error => ({
  type: ActionTypes.SEARCH_USER_FAIL, error });
