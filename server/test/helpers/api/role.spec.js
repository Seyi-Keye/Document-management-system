...
import { Document, Role, Document } from '../../../models';
...
describe('Document Api', () => {
  ...
  describe('Get a document', () => {
    it('should return a document matching an id', (done) => {
      request.get(`/documents/${publicDocumentId}`)
      .set({ 'x-access-token': token })
        .end((err, res) => {
    ...
    it('should return a private document to an admin', (done) => {
      request.get(`/documents/${privateDocumentId}`)
    ...
    (done) => {
      request.get(`/documents/${documentWithRoleAccessId}`)
      .set({ 'x-access-token': secondToken })
        .end((err, res) => {
          res.status.should.equal(200);
  ...
  describe('Get Documents', () => {
    ...
    (done) => {
      request.get('/documents?limit=26')
      .set({ 'x-access-token': secondToken })
        .end((err, res) => {
          res.status.should.equal(400);
    ...
    (done) => {
      request.get('/documents?offset=-1')
      .set({ 'x-access-token': secondToken })
        .end((err, res) => {
          res.status.should.equal(400);
          should(res.body).have.property('message');
  ...
  describe('Edit Document', () => {
    it('should allow an admin update any user\'s document.', (done) => {
      request.put(`/documents/${privateDocumentId}`)
    ...
    it('should not allow a user who is not logged in to update.', (done) => {
      request.put(`/documents/${publicDocumentId}`)
      .send(userData.updateDocument)
        .end((err, res) => {
          res.status.should.equal(401);
          should(res.body.message)
  ...
  describe('User\'s document', () => {
    it('should return all documents to the owner.', (done) => {
      request.get(`/users/${userId}/documents`)
      .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(200);
          res.body.documents.should.be.a.Array();
  ...
  describe('Paginate', () => {
    ...
    it('should return documents based on pagination', (done) => {
      request.get(`/users/${userId}/documents?limit=1&offset=1`)
        .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(200);
          res.body.documents.should.be.a.Array();
    ...
    (done) => {
      request.get(`/users/${userId}/documents?limit=1&offset=0`)
        .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(200);
          res.body.documents.should.be.a.Array();
    ...
    (done) => {
      request.get(`/users/${userId}/documents?limit=a&offset=0`)
        .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(400);
          res.body.message.should
    ...
    (done) => {
      request.get(`/users/${userId}/documents?limit=2&offset=q`)
        .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(400);
          res.body.message.should
  ...
  describe('Search:', () => {
    ...
    (done) => {
      request.get('/documents/search?search=Doc 1 edit&limit=10&offset=0')
      .set({ 'x-access-token': token })
      .end((err, res) => {
        res.status.should.equal(200);
        res.body.documents.should.be.a.Array();
    ...
    it('should return all documents to an admin', (done) => {
      request.get('/documents/search?search=Doc 1 edit')
      .set({ 'x-access-token': adminToken })
      .end((err, res) => {
        res.status.should.equal(200);
        res.body.documents.should.be.a.Array();
  ...
  describe('Delete', () => {
    it('should delete user document', (done) => {
      request.delete(`/documents/${publicDocumentId}`)
      .set({ 'x-access-token': token })
        .end((err, res) => {
          res.status.should.equal(200);
    ...
    (done) => {
      request.delete(`/documents/${privateDocumentId}`)
      .set({ 'x-access-token': secondToken })
        .end((err, res) => {
          res.status.should.equal(403);
          res.body.message.should
